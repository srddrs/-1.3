//
//  XuanFaHuoDiZhiViewController.m
//  yunlailaC
//
...
@interface XuanFaHuoDiZhiViewController ()
...
@implementation XuanFaHuoDiZhiViewController
...
- (void) initView
{
    ...
    UIView *bg = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 300, 120)];
    bg.backgroundColor = [UIColor whiteColor];
    [_mapView addSubview:bg];
    
    UIImageView *icon = [[UIImageView alloc] initWithFrame:CGRectMake(15, 10, 16, 21)];
    icon.image = [UIImage imageWithName:@"fahuo_qidian"];
    [bg addSubview:icon];

    
    label = [[UILabel alloc] initWithFrame:CGRectMake(35, 0, 250, 40)];
    ...
    UILabel *fgx = [[UILabel alloc] initWithFrame:CGRectMake(15, 40, 270, 1)];
    fgx.backgroundColor = fgx_13Color;
    [bg addSubview:fgx];
    
    UILabel *titleLable1 = [[UILabel alloc] initWithFrame:CGRectMake(15, 40, 80, 40)];
    ...
    dizhiText.frame = CGRectMake(80, 40, 210, 40);
    dizhiText.delegate = self;
    dizhiText.placeholder = @"请输入补充地址(如几楼几号)";
    ...
    [bg addSubview:dizhiText];
    
    UILabel *fgx1 = [[UILabel alloc] initWithFrame:CGRectMake(15, 80, 270, 1)];
    fgx1.backgroundColor = fgx_13Color;
    [bg addSubview:fgx1];
    
    UILabel *titleLable2 = [[UILabel alloc] initWithFrame:CGRectMake(15, 80, 60, 40)];
    ...
    lianxirenText.frame = CGRectMake(70, 80, 70, 40);
    lianxirenText.delegate = self;
    lianxirenText.placeholder = @"";
    ...
    lianxirenText.text = @"";
    [bg addSubview:lianxirenText];
    
    UILabel *titleLable3 = [[UILabel alloc] initWithFrame:CGRectMake(145, 80, 50, 40)];
    titleLable3.numberOfLines = 0;
    titleLable3.textAlignment = NSTextAlignmentLeft;
    titleLable3.font = viewFont1;
    titleLable3.textColor = font1_13Color;
    titleLable3.text = @"电话：";
...
//    dianhuaText.clearButtonMode = UITextFieldViewModeWhileEditing;
    ...
    dianhuaText.frame = CGRectMake(190, 80, 110, 40);
    dianhuaText.delegate = self;
    dianhuaText.placeholder = @"";
    dianhuaText.returnKeyType = UIReturnKeyDone;
    dianhuaText.keyboardType = UIKeyboardTypePhonePad;
    dianhuaText.font = viewFont1;
    dianhuaText.textColor = fontColor;
    dianhuaText.text = @"";
    [bg addSubview:dianhuaText];
    ...
    UIImageView *icon1 = [[UIImageView alloc] initWithFrame:CGRectMake(160-6, _mapView.frame.size.height/2-10-44, 13, 20) ];
    icon1.image = [UIImage imageNamed:@"dingwei"];
    [_mapView addSubview:icon1];
}
