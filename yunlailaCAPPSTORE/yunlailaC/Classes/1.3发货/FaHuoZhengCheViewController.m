...
@interface FaHuoZhengCheViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,XuanFaHuoDiZhiViewControllerDelegate>
{
    ...
    UITextField *huoDunText; //货物顿数
    UITextField *huoFangText;  //货物方数
    UIButton *gouBtn;
}

@end

@implementation FaHuoZhengCheViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
          return 170*APP_DELEGATE().autoSizeScaleY;
    }
...
#pragma mark - 货物顿数
    else if (indexPath.section==1&&indexPath.row==2)
    {
        ...
        if (!huoDunText)
        {
            huoDunText = [[UITextField alloc] init];
            huoDunText.clearButtonMode = UITextFieldViewModeWhileEditing;
            huoDunText.borderStyle = UITextBorderStyleNone;
            huoDunText.textColor = fontColor;
            huoDunText.frame = CGRectMake(90*APP_DELEGATE().autoSizeScaleX, 0, 200*APP_DELEGATE().autoSizeScaleX, 44*APP_DELEGATE().autoSizeScaleY);
            huoDunText.delegate = self;
            huoDunText.placeholder = @"请输入货物吨数";
            huoDunText.returnKeyType = UIReturnKeyDone;
            huoDunText.keyboardType = UIKeyboardTypeNumberPad;
            huoDunText.font = viewFont1;
            huoDunText.text = @"";
            
        }
        [cell.contentView addSubview:huoDunText];
    }
...
#pragma mark - 货物方数
    else if (indexPath.section==1&&indexPath.row==3)
    {
        ...
        titleLable1.font = viewFont1;
        titleLable1.textColor = font1_13Color;
        titleLable1.text = @"货物方数";
        [cell.contentView addSubview:titleLable1];
        
        if (!huoFangText)
        {
            huoFangText = [[UITextField alloc] init];
            huoFangText.clearButtonMode = UITextFieldViewModeWhileEditing;
            huoFangText.borderStyle = UITextBorderStyleNone;
            huoFangText.textColor = fontColor;
            huoFangText.frame = CGRectMake(90*APP_DELEGATE().autoSizeScaleX, 0, 200*APP_DELEGATE().autoSizeScaleX, 44*APP_DELEGATE().autoSizeScaleY);
            huoFangText.delegate = self;
            huoFangText.placeholder = @"请输入货物件数";
            huoFangText.returnKeyType = UIReturnKeyDone;
            huoFangText.keyboardType = UIKeyboardTypeNumberPad;
            huoFangText.font = viewFont1;
            huoFangText.text = @"";
            
        }
        [cell.contentView addSubview:huoFangText];
    }
    #pragma mark - 协议
