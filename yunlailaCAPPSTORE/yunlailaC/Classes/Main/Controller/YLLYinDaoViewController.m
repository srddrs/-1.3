...
- (void)initView
{
    ...
    submitBtn = [[UIButton alloc] initWithFrame: CGRectMake(35*APP_DELEGATE().autoSizeScaleX, 420*APP_DELEGATE().autoSizeScaleY, 250*APP_DELEGATE().autoSizeScaleX, 34*APP_DELEGATE().autoSizeScaleY)];
    ...
    NSArray *picArr = @[@"daohangye_01",@"daohangye_02",@"daohangye_03"];
    for (int i = 0; i < 3; i++) {
